...
_Figure 1: Snapshot of the raw dataframe (left) and the list of possible diseases (right)._
...
_Figure 2: The properties of the custom Neural Network class implemented from scratch._
...
_Figure 3: The UI allowing users to select symptoms._
...
_Figure 4: Diagnosing the common cold required selecting over 10 specific symptoms to cross the confidence threshold._
